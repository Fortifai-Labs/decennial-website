        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
                ...
                <div key={link.label} className="relative group">
                  <a
                    ...
                    className={clsx(
                      ...
                      textColor,
                      'hover:text-[var(--decennial-secondary)]'
                    )}
                  >
                    {link.label}
            ...
            <div className="hidden md:block">
              <a
                href={ctaHref}
                className="inline-flex items-center px-4 py-2 text-sm font-medium text-[var(--decennial-primary)] bg-[var(--decennial-secondary)] rounded-lg hover:bg-[var(--decennial-secondary-hover)] transition-colors"
              >
                {ctaText}
              </a>
            </div>
